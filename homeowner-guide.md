...
1. Click the link in the invitation email — it's valid for 7 days
2. Set a password (minimum 8 characters, uppercase + lowercase + digit)
3. Verify your email address with the 6-digit code sent to you
4. You're taken to your homeowner portal
...
**Tenants:** If you are a tenant rather than the property owner, your experience is identical to a homeowner's. You can see violations for your unit, view documents, and receive notifications.
...
- **Active violations** for your unit — current count and status
- **Recent announcements** from your board
- **Quick links** to violations, documents, and settings

The navigation gives access to:
...
## Understanding a Violation Notice
...
- Photos taken by the board member
- The rule or CC&R section cited
- The cure deadline — the date by which you need to resolve the issue
- A countdown timer showing days remaining

**Violation statuses:**

| Status             | What it means for you                                                 |
| ------------------ | --------------------------------------------------------------------- |
| Open               | The violation has been recorded but no formal notice sent yet         |
| First Notice Sent  | You have received a formal notice; the cure deadline is running       |
| Second Notice Sent | The cure deadline passed without resolution; a second notice was sent |
| Resolved           | Your board confirmed that the issue has been corrected                |
| Closed             | The violation was closed by the board                                 |
| Waived             | The board chose not to enforce this violation                         |

**Downloading your notice:** Open the violation → go to the **Notices** tab → click the PDF link to download the formal notice letter.
...
3. Write a description explaining the situation or what you have done to resolve it
...
The document library contains your community's governing documents, meeting minutes, forms, and notices.

**Accessing documents:**

1. Go to **Documents**
2. Use the category tabs to filter: CC&Rs, Bylaws, Meeting Minutes, Budget, Rules & Regulations, Forms, Notices

**Downloading a document:** Click any document row to download it.

**Board-only documents** are not visible to homeowners — only documents marked as "Public" by your board appear in your library.
...
- A violation on your unit has been resolved or closed
- A new community announcement has been posted

**Email notifications** are always sent for violation notices and other legally significant events. Email is the primary notification channel.
...
**Managing your notification preferences:** Go to **Settings** → Notifications to enable or disable specific notification types.
...
2. Edit your first name or last name
3. Click **Save**

### Changing your password

1. Go to **Settings** → click **Change Password**
...
Email changes require board approval to protect your account:

1. Go to **Settings** → click **Change Email**
2. Enter your new email address and current password
